...
impl Emojify {
    pub fn new() -> Emojify {
        let child = process::Command::new("python3").arg("servers/deepmoji/server.py").stdin(process::Stdio::piped()).stdout(process::Stdio::piped()).spawn().unwrap();
        Emojify {
